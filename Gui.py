...
feature1_cmb.place(x=310, y=130)
...
feature2_cmb.place(x=310, y=200)
...
epoch_txt.place(x=310, y=480)

threshold_lbl = Label(gui, text="Enter the threshold of mse", fg='black', font=("Times New Roman", 14))
threshold_lbl.place(x=50, y=550)
threshold_txt = Entry(gui, bg='white', fg='black', bd=9, width=27)
threshold_txt.place(x=310, y=550)

bias_lbl = Label(gui, text="Add bias or not", fg='black', font=("Times New Roman", 14))
bias_lbl.place(x=50, y=620)
